    ...
    <body>
        <div style="margin-top: 10px;">
            <div >
                ...
                <div class="col-md-4">
                    <!-- Info Boxes Style 2 -->
                    <div class="info-box" style="background: #128c7e;">
                        <span class="info-box-icon"><i class="fa fa-coffee" style="color: #fff;"></i></span>         
                ...
                <div class="col-md-4">
                    <div class="info-box" style="background: #128c7e;">
                        <span class="info-box-icon"><i class="fa fa-cutlery" style="color: #fff;"></i></span>
                ...
                <div class="col-md-4">
                    <div class="info-box" style="background: #128c7e;">
                        <span class="info-box-icon"><i class="fa fa-glass" style="color: #fff;"></i></span>
                ...
                <div class="col-md-4">
                    <div class="info-box" style="background: #128c7e;">
                        <span class="info-box-icon"><i class="fa fa-coffee" style="color: #fff;"><span style="font-size: 25px;">G</span></i></span>
                ...
                <div class="col-md-4">
                    <div class="info-box" style="background: #128c7e;">
                        <span class="info-box-icon"><i class="fa fa-cutlery" style="color: #fff;"><span style="font-size: 25px;">&nbsp;G</span></i></i></span>
                ...
                <div class="col-md-4">
                    <div class="info-box" style="background: #128c7e;">
                        <span class="info-box-icon"><i class="fa fa-glass" style="color: #fff;"><span style="font-size: 25px;">G</span></i></i></span>
                ...
                <div class="col-md-4">
                    <div class="info-box" style="background: #128c7e;">
                        <span class="info-box-icon"><i class="fa fa-coffee" style="color: #fff;"><span style="font-size: 25px;">E</span></i></i></span>
                ...
                <div class="col-md-4">
                    <div class="info-box" style="background: #128c7e;">
                        <span class="info-box-icon"><i class="fa fa-cutlery" style="color: #fff;"><span style="font-size: 25px;">&nbsp;E</span></i></span>
                ...
                <div class="col-md-4">
                    <div class="info-box" style="background: #128c7e;">
                        <span class="info-box-icon"><i class="fa fa-glass" style="color: #fff;"><span style="font-size: 25px;">E</span></i></span>
                ...
                <div class="col-md-4">
                    <div class="info-box" style="background: #128c7e;">
                        <span class="info-box-icon"><i class="fa fa-money" style="color: #fff;"></i></span>
                ...
                <div class="col-md-4">
                    <div class="info-box" style="background: #128c7e;">
                        <span class="info-box-icon"><i class="fa fa-user-circle" style="color: #fff;"><span style="font-size: 25px;">P</span></i></span>
                ...
                <div class="col-md-4">
                    <div class="info-box" style="background: #128c7e;">
                        <span class="info-box-icon"><i class="fa fa-hospital-o" style="color: #fff;"></i></span>
                ...
                <div class="col-md-4">
                    <div class="info-box" style="background: #128c7e;">
                        <span class="info-box-icon"><i class="fa fa-frown-o" style="color: #fff;"></i></span>
