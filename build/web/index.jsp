<%-- 
    Document   : index
    Created on : 21/08/2018, 04:13:13 PM
    Author     : TIC-32
--%>
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        <li class="header"><center>MENU DE NAVEGACIÓN</center></li>
                        <li class="active treeview">
                            ...
                            <ul class="treeview-menu">
                                <li class="active"><a id="menu_uno" href="#"><i class="fa fa-circle-o"></i> Dashboard </a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
                                <i class="fa fa-pie-chart"></i>
                                <span>Registrar Comidas</span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
