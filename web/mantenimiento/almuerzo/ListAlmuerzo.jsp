            ...
            <table class="table table-bordered table-condensed table-hover">
                ...
                <tbody id="datos">
                    <%                       
                        ...
                        COMANDO = "SELECT idalmuerzo, nom_pen(d.idpensionista) AS Nombres, p.tipo, IF(p.tipo=0, 'General', 'Ejecutivo') as nom_tipo, "
