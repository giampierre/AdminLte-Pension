...
<html>
    <head>
        ...
        <script>
            ...
            function enviar() {
                $("iframe").remove();
                var url = 'views/Comidas/Almuerzos.jsp';
    ...
    <body>
        ...
        <form name="datoslist" target="view" id="datoslist" action="views/Comidas/Almuerzos.jsp">


          
                <div class="panel panel-info" style="color: #fff;">
                    <div class="panel-heading info-box-text" style="color:#fff; background: #3b6486;"> <h5><b>Lista de Almuerzos por periodo y tipo</b></h5></div>
