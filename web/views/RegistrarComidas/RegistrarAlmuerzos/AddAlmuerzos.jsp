<%-- 
    Document   : AddAlmuerzo
    Created on : 30/10/2018, 10:00:38 AM
    Author     : TIC-32
--%>
        ...
        <%
            ...
            if (rs.next()) {
                ...
                if (tipo_pensionista.equals("0") & s_estado.equals("1")) {
                    ...
                    int rs2 = Estamento.executeUpdate("INSERT INTO almuerzo (idALMUERZO, idPENSIONISTA, titulo, estado, fecha_a, monto, cantidad) VALUES "
                            + "(NULL, '" + idpensionista + "', 'ALMUERZO', '" + s_estado + "'"
                            + ", sysdate(), '5.5', '"+ s_cantidad +"');");
