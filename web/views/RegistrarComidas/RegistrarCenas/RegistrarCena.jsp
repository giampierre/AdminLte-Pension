<%-- 
    Document   : RegistrarCena
    Created on : 24/10/2018, 09:41:33 AM
    Author     : TIC-32
--%>
...
<html>
    <head>
        ...
        <script src="dist/js/AjaxRegistrarCena.js" type="text/javascript"></script>
    ...
    <body onload="acceso.dni.focus()">
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div>
                    <!-- /.box-header -->
                    <div style="background-image: url('dist/img/cena.jpg');  width: 100%; height: 82vh;" >
                                ...
                                <tr align="center">
                                    <td>
                                        ...
                                        <div style="width: 50%;"  class="alert alert-warning">
                                            <p style="font-size: 35px;" class="text-center fa fa-glass"><b>&nbsp;&nbsp;CENAS</b>&nbsp;</p>
                                        </div>
                                    </td>
                                </tr>
                                <tr align="center">                                 
                                    <td>
                                        <div style="width: 50%; font-size: 20px;"  class="alert alert-success message salida" id="salida">Ingrese su código para registrar su cena</div>
                                    </td>                             
                                </tr>
                                <!--tr align="center">
                                    <td>
                                ...
                                <div class="form-inline">
                                    ...
                                    <div class="form-group">
                                        <select class="form-control" name="estado" id="estado">
                                            <option value="0" selected>Cené en la pensión</option>
                                            <option value="1">Cena para llevar</option>
                                        </select>
                                    </div>
                                </div>
