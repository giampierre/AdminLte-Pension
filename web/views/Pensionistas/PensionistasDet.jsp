                                    ...
                                    <%
                                        ...
                                        String info = "#00c0ef";
                                         ...
                                         COMANDO = "SELECT p.idPENSIONISTA, CONCAT(pe.Nombres, ' ', pe.Apellidos) as Nombres, p.monto, "
                                                    ...
                                                    + " SUM(monto*cantidad) as consDesa "
                                                    + "FROM desayuno "
                                                    + "GROUP BY idPENSIONISTA) d "
                                                    + "ON p.idPENSIONISTA = d.idPENSIONISTA "
                                                    + "LEFT JOIN "
                                                    + "(SELECT idPENSIONISTA, SUM(cantidad) as cantAlmu, SUM(monto*cantidad) as consAlmu "
                                                    + "FROM almuerzo "
                                                    + "GROUP BY idPENSIONISTA) a "
                                                    + "ON p.idPENSIONISTA = a.idPENSIONISTA "
                                                    + "LEFT JOIN "
                                                    + "(SELECT idPENSIONISTA, SUM(cantidad) as cantCena, SUM(monto*cantidad) as consCena "
                                                    + "FROM cena "
